...
import { MapPin, Phone, Building2, Image as ImageIcon, MapPinned, Plus } from "lucide-react";
...
export const AddCenterForm = () => {
    ...
    const { createCenter, isProcessing } = useCenters();
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        const success = await createCenter({
            name: formData.name,
